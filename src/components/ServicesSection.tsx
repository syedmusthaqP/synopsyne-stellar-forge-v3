          ...
          <div className="relative h-[800px]">
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className={`relative bg-black/40 backdrop-blur-sm p-8 rounded-3xl border transition-all duration-500 max-w-sm ${
                  activeService === index ? 'border-cyan-400 shadow-2xl scale-105' : 'border-white/20 group-hover:border-cyan-400/50'
                }`}>
                  <div className="mb-6">
                    <div className={`w-16 h-16 rounded-lg bg-gradient-to-r from-cyan-500/20 to-blue-500/20 flex items-center justify-center mb-4 transition-transform duration-500 ${
                  ...
                  <button className={`w-full py-2 text-cyan-400 border border-cyan-400/30 rounded-lg transition-all ${
