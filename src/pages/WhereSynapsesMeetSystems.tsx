              ...
              <div className="lg:col-span-2 space-y-6">
                <div>
                  <div className="flex items-center gap-4 mb-4">
                    <h3 className="text-3xl font-bold text-white">Syed Musthaq</h3>
                    <a 
                      href="/founder" 
                      className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-4 py-2 rounded-full text-sm font-medium hover:from-cyan-400 hover:to-purple-400 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-cyan-500/25"
                    >
                      View Profile
                    </a>
                  </div>
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <a 
                      href="https://wa.me/1234567890?text=Hello%20from%20Synopsyne%20Dynamics%20website!"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-green-500/25"
                    >
