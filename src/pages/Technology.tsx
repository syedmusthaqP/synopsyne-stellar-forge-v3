      ...
      <section className="min-h-screen flex items-center justify-center relative pt-20">
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="inline-flex items-center glassmorphism px-6 py-2 rounded-full mb-8 animate-float">
            <Cpu className="w-4 h-4 text-neon mr-2" />
            <span className="text-white text-sm">Neural Technology</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Our <span className="text-neon animate-text-glow">Technology</span>
            <br />
            Stack
          </h1>
          ...
          <div className="relative mb-12 max-w-4xl mx-auto">
            ...
            <div className="relative glassmorphism p-6 rounded-lg">
              <p className="text-lg md:text-xl text-gray-300">
                Explore our cutting-edge technology ecosystem that powers neural connections 
                and drives innovation across all our solutions.
              </p>
            </div>
          </div>
        </div>
